...
import { Mail, Lock, AlertCircle, ArrowRight, Loader2, Zap, Star } from "lucide-react"
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (err.response?.status === 404) {
                setError("you are new user so you have to signup")
            } else {
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center ml-2">
                                ...
                                <button type="button" className="text-[10px] font-black text-blue-600 uppercase tracking-[0.2em] italic">
                                    Reset Link?
                                </button>
                            </div>
                            <div className="relative">
